...
const DoctorHospitalAdmissions = ({ patientId }) => {
  ...
  const fetchAdmissions = async () => {
    try {
      ...
      console.log('Fetching admissions for patient ID:', patientId)
  ...
  if (admissions.length === 0) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600">This patient has no hospital admission records.</p>
      </div>
    )
  }
...
export default DoctorHospitalAdmissions
