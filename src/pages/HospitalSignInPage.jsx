            ...
            <div className="text-center lg:text-left">
              <div className="mb-8">
                ...
                <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                  Welcome Back, <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">Hospital</span>
                </h2>
                <p className="text-xl text-gray-600 leading-relaxed mb-8">
                  Sign in to access your facility dashboard and continue providing excellent healthcare services. Manage your patients, staff, and medical operations efficiently.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
              <div className="bg-gradient-to-r from-green-600 to-emerald-600 px-6 py-4">
                <h3 className="text-white font-semibold text-lg">Sign In to Your Hospital</h3>
                <p className="text-green-100 text-sm">Access your facility dashboard</p>
              </div>
              <div className="p-6">
                <SignIn 
                  routing="hash" 
                  signUpUrl="/auth/hospital" 
                  afterSignInUrl="/dashboard/hospital"
                  appearance={{
                    elements: {
            ...
            <div className="mt-6 text-center">
              <div className="bg-white/60 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                <p className="text-gray-600">
                  ...
                  <Link to="/auth/hospital" className="text-green-600 hover:text-green-700 font-semibold transition-colors duration-200">
                    Sign up here
                  </Link>
                </p>
              </div>
